...
public class KafkaListeners {
    ...
    void listenerAuxiliarySystems(String analysisResultModelString) {
        AnalysisResultModel analysisResultModel = objectMapper.convertValue(analysisResultModelString, AnalysisResultModel.class);
    ...
    void listenerControlSystems(String analysisResultModelString) {
        AnalysisResultModel analysisResultModel = objectMapper.convertValue(analysisResultModelString, AnalysisResultModel.class);
    ...
    void listenerEngineSystems(String analysisResultModelString) {
        AnalysisResultModel analysisResultModel = objectMapper.convertValue(analysisResultModelString, AnalysisResultModel.class);
    ...
    void listenerMountingSystems(String analysisResultModelString) {
        AnalysisResultModel analysisResultModel = objectMapper.convertValue(analysisResultModelString, AnalysisResultModel.class);
    ...
    void listenerPowerTransmission(String analysisResultModelString) {
        AnalysisResultModel analysisResultModel = objectMapper.convertValue(analysisResultModelString, AnalysisResultModel.class);
