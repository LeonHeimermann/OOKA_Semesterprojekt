...
import org.ooka.msmountingsystems.dto.AnalysisResult;
    ...
    public void run() {
        try {
            ...
            if (algorithmSucceeded) {
                ...
                kafkaTemplate.send("heimermann_weglau_analyse_result", new AnalysisResult("mountingsystems", true).toString());
            } else {
                System.out.println("Algorithm failed");
                kafkaTemplate.send("heimermann_weglau_analyse_result", new AnalysisResult("mountingsystems", false).toString());
            }
