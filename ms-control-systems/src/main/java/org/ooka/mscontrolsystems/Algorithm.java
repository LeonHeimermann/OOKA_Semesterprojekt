...
import org.ooka.mscontrolsystems.dto.AnalysationResult;
    ...
    public void run() {
        try {
            ...
            if (algorithmSucceeded) {
                ...
                kafkaTemplate.send("heimermann_weglau_analyse_result", new AnalysationResult("controlsystems", true).toString());
            } else {
                System.out.println("Algorithm failed");
                kafkaTemplate.send("heimermann_weglau_analyse_result", new AnalysationResult("controlsystems", false).toString());
            }
